                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        ...
                        <ul id="home" class="collapse in" aria-expanded="true">
                            ...
                            <li>
                                    <a href="homecreate" class="active"><i class="fa fa-fw fa-plus-circle"></i> Add Appliance/Room</a>
                            </li>
                            <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-plus-circle"></i> Add Appliance/Room
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i> New appliance</h3>
                            </div>
                            <div class="panel-body">

                                <form role="form" method="post" action="homecreate">

                                    <div class="form-group">
                                        <label>Description</label>
                                        <input class="form-control" name="description" placeholder="e.g. hall plug 1">
                                    </div>

                                    <div class="form-group">
                                        <label>Vendor name</label>
                                        <input class="form-control" name="vendorname" placeholder="e.g. 19E1B32">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="optionsRadios" id="optionsRadios1" value="Stealth" checked>Stealth
                                            </label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                        ...
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="optionsRadios" id="optionsRadios3" value="Circle+">Circle+
                                            </label>
                                        </div>
                                        <div class="radio">
                                            <label>
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i> New room</h3>
                            </div>
                            <div class="panel-body">
                                <form role="form" method="post" action="homecreate">
                                    <div class="form-group">
                                        <label>Room name</label>
                                        <input class="form-control" name="name" placeholder="Living room 1">
                                    </div>
                                    <div class="form-group">
