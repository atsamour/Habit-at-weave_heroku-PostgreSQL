...
<head>
    ...
    <title>Habitatweave: Home appliances</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            ...
                            <br><small>Home appliances</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-fw fa-plug"></i> <a href="plugwise"> Plugwise</a>
                            </li>
                        </ol>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-fw fa-leaf"></i><a href="currentcost"> Current Cost</a>
                            </li>
                        </ol>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-fw fa-plus-circle"></i><a href="homecreate"> Add Appliance/Room</a>
                            </li>
                        </ol>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-fw fa-building-o"></i><a href="arrangerooms"> Arrange in Rooms</a>
                            </li>
                        </ol>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-fw fa-power-off"></i><a href="switchplugs"> Switch plugs</a>
                            </li>
                        </ol>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-fw fa-calendar"></i><a href="schedules"> Schedule Appliances</a>
                            </li>
                        </ol>
                    </div>
                </div>
